...
social: false # social icons are already shown in the navbar
...
My research focuses on <span class="research-area">High-Performance Computing (HPC)</span> and <span class="research-area">AI Infrastructure</span>, with an emphasis on observability, resource management, and energy efficiency. Building on this systems foundation, my research agenda extends to <span class="research-area">AI agents for HPC operations</span>, the <span class="research-area">security of agents acting within HPC environments</span>, and the <span class="research-area">integration of HPC with quantum computing</span>.
