...
I am currently an Research Assistant Professor in the Department of Computer Science at Texas Tech University, where I also serve as the technical lead for the [Data-Intensive Scalable Computing Laboratory (DISCL)](https://discl.cs.ttu.edu/) and the [NSF Cloud and Autonomic Computing Center (CAC IUCRC)](https://nsfcac.org/).
